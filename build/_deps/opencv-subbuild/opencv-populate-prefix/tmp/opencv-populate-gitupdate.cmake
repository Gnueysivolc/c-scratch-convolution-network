...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "4.9.0"
  WORKING_DIRECTORY "/home/ha/Documents/code/c++/c-scratch-convolution-network/build/_deps/opencv-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ha/Documents/code/c++/c-scratch-convolution-network/build/_deps/opencv-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ha/Documents/code/c++/c-scratch-convolution-network/build/_deps/opencv-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
